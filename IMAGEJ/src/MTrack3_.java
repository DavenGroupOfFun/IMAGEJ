...
public class MTrack3_ implements PlugInFilter, Measurements  {
	...
	//ellie edit
	public static void setProperty (String arg1, String arg2, String arg3, String arg4) {
		directory=arg3;
		filename=arg4;
	...
	public void run(ImageProcessor ip) {
		...
		if (bSaveResultsFile) {
			...
			// directory=System.getProperty("user.home")+"/Desktop/MACROTEST/Results";
			// filename= "/test1.txt";
		}
	...
	public static void track(ImagePlus imp, int minSize, int maxSize, float maxVelocity, String directory, String filename) {
